...
p1 = o1.pets.create(name: "Firulais", species: "Perro", breed: "Quiltro", date_of_birth: "2020-02-20", weight: 15.5)
p2 = o1.pets.create(name: "Michi", species: "Gato", breed: "Persa", date_of_birth: "2024-04-24", weight: 4.2)
p3 = o2.pets.create(name: "Zanahoria", species: "Conejo", breed: "Cabeza de León", date_of_birth: "2022-02-22", weight: 1.8)
p4 = o3.pets.create(name: "Bimbo", species: "Perro", breed: "Pastor Alemán", date_of_birth: "2019-09-19", weight: 30.0)
p5 = o3.pets.create(name: "Garfield", species: "Gato", breed: "Exótico de Pelo Corto", date_of_birth: "2008-08-18", weight: 3.5)
...
a1 = Appointment.create(pet: p1, vet: v1, date: DateTime.now - 2.days, reason: "Cirugía de esterilización", status: 2)
a2 = Appointment.create(pet: p2, vet: v2, date: DateTime.now - 1.day, reason: "Chequeo preventivo", status: 2)
a3 = Appointment.create(pet: p3, vet: v2, date: DateTime.now + 1.day, reason: "Vacunación", status: 0)
a4 = Appointment.create(pet: p4, vet: v1, date: DateTime.now, reason: "Herida en pata trasera", status: 1)
a5 = Appointment.create(pet: p5, vet: v2, date: DateTime.now - 5.days, reason: "Control de peso", status: 3)
...
puts "Base de datos generada para vets (lab3)"